...
// CHTStickerView
#define COCOAPODS_POD_AVAILABLE_CHTStickerView
#define COCOAPODS_VERSION_MAJOR_CHTStickerView 0
...
#define COCOAPODS_VERSION_MINOR_RevMob 5
#define COCOAPODS_VERSION_PATCH_RevMob 5
